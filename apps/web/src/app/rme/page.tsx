        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 mb-6 shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition-colors duration-500">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            <div className="bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 rounded-xl border border-slate-100 dark:border-slate-700 flex-1 md:flex-none transition-colors duration-500 text-left">
              ...
              <p className="text-sm font-black text-slate-800 dark:text-slate-200">#{appointmentId?.padStart(3, '0') || '---'}</p>
            </div>
            <div className="bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 rounded-xl border border-slate-100 dark:border-slate-700 flex-1 md:flex-none transition-colors duration-500 text-left">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 shadow-sm border border-slate-200 dark:border-slate-700 transition-colors duration-500">
            ...
            <div className="space-y-6 text-left">
              ...
              <div>
                <label className="text-xs font-bold text-emerald-600 dark:text-emerald-400 mb-2 block uppercase tracking-wider transition-colors duration-500 text-left">Plan (Tatalaksana & Resep Obat)</label>
